/**
 * CMECePortalUpdEmplyrWebServiceSOAPStub.java
 *
...
public class CMECePortalUpdEmplyrWebServiceSOAPStub extends org.apache.axis.client.Stub implements uk.gov.gsi.childmaintenance.www.futurescheme.interfaces.CMECePortalUpdEmplyrWebService.CMECePortalUpdEmplyrWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("updateEmployerBasicDtls");
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "updEmplyrResponse"));
    ...
    public CMECePortalUpdEmplyrWebServiceSOAPStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CMECePortalUpdEmplyrWebServiceSOAPStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CMECePortalUpdEmplyrWebServiceSOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.childmaintenance.gsi.gov.uk/futurescheme/bo/esb/eportal/CmecUpdEmplyrBasicDtlsRequest", "CmecUpdEmplyrBasicDtlsRequest");
            cachedSerQNames.add(qName);
            cls = uk.gov.gsi.childmaintenance.www.futurescheme.bo.esb.eportal.CmecUpdEmplyrBasicDtlsRequest.CmecUpdEmplyrBasicDtlsRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public uk.gov.gsi.childmaintenance.www.futurescheme.bo.esb.eportal.CmecUpdEmplyrResponse.CmecUpdEmplyrResponse updateEmployerBasicDtls(uk.gov.gsi.childmaintenance.www.futurescheme.bo.esb.eportal.CmecUpdEmplyrBasicDtlsRequest.CmecUpdEmplyrBasicDtlsRequest updEmplyrRequest) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://www.childmaintenance.gsi.gov.uk/futurescheme/interfaces/CMECePortalUpdEmplyrWebService/updateEmployerBasicDtls");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.childmaintenance.gsi.gov.uk/futurescheme/interfaces/CMECePortalUpdEmplyrWebService", "updateEmployerBasicDtls"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {updEmplyrRequest});
